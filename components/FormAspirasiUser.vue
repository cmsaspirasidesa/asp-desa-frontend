  ...
  >
    <div>
      <div class="px-4 mx-auto">
        <h2
          class="mb-5 text-3xl font-bold text-gray-900 dark:text-white text-center"
        >
          Form Aspirasi
        </h2>
      </div>
    ...
    <div class="mt-2">
      <div class="flex justify-between">
        ...
        <div v-if="isLimit">
          <p class="text-red-600 leading-6 text-sm font-medium">
            Maksimal unggah 4 gambar yang diizinkan.
          </p>
        </div>
      </div>
      <div
    ...
    <div v-if="image" class="flex flex-wrap w-full gap-2 mt-2 justify-center">
      <div
