      ...
      <div
        ...
        <div class="p-6 space-y-4 md:space-y-6 sm:py-4">
          ...
          <form class="space-y-4 md:space-y-2" @submit.prevent="register">
            ...
            <div class="pt-5">
              <button type="submit"
                class="w-full text-white bg-indigo-600 font-bold hover:bg-indigo-500 focus:ring-4 focus:outline-none focus:ring-primary-300 rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                Daftar
              </button>
            </div>
            <div>
