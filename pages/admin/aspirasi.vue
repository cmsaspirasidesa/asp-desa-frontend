      ...
      <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        ...
        >
          <tr>
            ...
            <th
              scope="col"
              class="w-[100px] py-2 text-base text-center"
            >
              Status
            </th>
            <th
        ...
        <tbody>
          <tr
            v-for="(aspiration, index) of listAspirations.data.data"
          ...
          >
            ...
            <td
              ...
              "
              v-if="aspiration.status === 'Diajukan'"
              class="flex py-4"
            >
              <p
                class="py-2 text-center text-blue-500 uppercase border border-solid border-blue-500 w-[90px]"
              >
                {{ aspiration.status }}
              </p>
            </td>
            <td
              ...
              "
              v-else-if="aspiration.status === 'Diproses'"
              class="flex py-4"
            >
              <p
                class="px-4 py-2 text-orange-500 uppercase border border-solid border-orange-500 w-[90px]"
              >
                {{ aspiration.status }}
              </p>
            </td>
            ...
            >
              <p
                class="px-4 py-2 uppercase text-green-500 border border-solid border-green-500 w-[90px] text-center"
              >
                {{ aspiration.status }}
              </p>
            </td>
                    ...
                    <div class="sm:flex sm:items-start">
                      ...
                      >
                        ...
                        <div class="flex flex-col mt-4">
                          <label
                            for="coment"
                            class="text-base font-semibold leading-6 text-gray-900 mb-1"
                            >Komentar</label
                          >
                          <textarea
                            type="text"
              ...
              <div class="w-[600px] mx-8">
                ...
                <div class="flex justify-between items-center my-2 mb-4">
                  <h2 class="text-lg text-start font-medium">
                    Pembuat<span class="font-normal"
                      ><br />{{ dataModal.nama }}</span
                    >
                  </h2>
